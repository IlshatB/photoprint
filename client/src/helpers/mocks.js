...
export const photoBooks = [
    ...
    },
    {
        ...
        description: 'Солидные фотокниги на плотной премиальной фотобумаге в твердой ламинированной обложке, в которую можно добавить от 10 до 480 фотографий. описание товара 3. описание товара 3.',
        price: 4000,
        productionTime: '3d',
        image: photobook,        
    },
    ...
    },
    {
        id: '5',
        title: 'товар 5',
        description: 'описание товара 5 описание товара 5 описание товара 5 описание товара 5 описание товара 5 описание товара 5 описание товара 5',
        price: 4000,
        productionTime: '2h',
        image: photobook,        
    },
